...
public class AirportTest {
    ...
    public void testGetTransportMilitaryPlanes() {
        ...
        transportMilitaryPlanes.forEach(militaryPlane -> Assert.assertTrue(militaryPlane.getType() == MilitaryTypes.TRANSPORT));
    }
    ...
    public void testNextPlaneMaxLoadCapacityIsHigherThanCurrent() {
        ...
        IntStream.range(0, planesSortedByMaxLoadCapacity.size() - 1).forEachOrdered(i -> {
            Assert.assertFalse(planesSortedByMaxLoadCapacity.get(i).getMinLoadCapacity()
    ...
    public void testHasAtLeastOneBomberInMilitaryPlanes() {
        ...
        bomberMilitaryPlanes.forEach(militaryPlane ->  Assert.assertTrue(militaryPlane.getType() == MilitaryTypes.BOMBER));
    }
    ...
    public void testExperimentalPlanesHasClassificationLevelHigherThanUnclassified(){
        ...
        experimentalPlanes.forEach(experimentalPlane -> Assert.assertFalse(experimentalPlane.getClassificationLevel() == ClassificationLevel.UNCLASSIFIED));
    }
}
